...
let xizmatlar_modal_btn = document.querySelectorAll(".xizmatlar_btn")
let kurslar_modal_btn = document.querySelectorAll(".kurslar_btn")
let helper_class = document.querySelector(".helper_class")
xizmatlar_modal_btn.forEach((el) => {
    el.firstElementChild.addEventListener("click", () => {
        ...
        helper_class.innerHTML = parentel.classList[1]
        help_modal.classList.add("opened")
        help_modal.classList.add("xizmatlar_modal")
        help_modal.classList.remove("kurslar_modal")
...
kurslar_modal_btn.forEach((el) => {
    el.firstElementChild.addEventListener("click", () => {
        ...
        help_modal.classList.add("opened")
        help_modal.classList.remove("xizmatlar_modal")
        help_modal.classList.add("kurslar_modal")
...
let hero_form_input = document.querySelectorAll(".main-hero_form_inputs")
...
kurslar_form = document.querySelector(".kurslar_form")
xizmatlar_form = document.querySelector(".xizmatlar_form")

setInterval(() => {
    kurs_help_modal = document.querySelectorAll(".kurslar_modal .main-help_modal_btn_wrapper button")
    kurs_help_modal.forEach((element) => {
        element.addEventListener("click", () => {
            let link = document.querySelector(".kurslar_modal .main-help_modal_heading").innerText.replace(" ", "").toLowerCase()
            let label_name = document.querySelectorAll(`.label_${helper_class.innerHTML}`)
            label_name.forEach(element => {
                element.classList.add("selected")
                element.nextElementSibling.classList.add("selected")
            });
            kurslar_form.style.display = "flex"
            xizmatlar_form.style.display = "none"
        })
    });
}, 100)
...
setInterval(() => {
    xizmatlar_help_modal = document.querySelectorAll(".xizmatlar_modal .main-help_modal_btn_wrapper button")
    xizmatlar_help_modal.forEach((element) => {
        element.addEventListener("click", () => {
            let link = document.querySelector(".xizmatlar_modal .main-help_modal_heading").innerText.replace(" ", "-").toLowerCase().replace("ulash", "")
            let label_name = document.querySelectorAll(`.label_${helper_class.innerHTML}`)
            label_name.forEach(element => {
                element.classList.add("selected")
                element.nextElementSibling.classList.add("selected")
            });
            kurslar_form.style.display = "none"
            xizmatlar_form.style.display = "flex"
        })
    });
}, 100)